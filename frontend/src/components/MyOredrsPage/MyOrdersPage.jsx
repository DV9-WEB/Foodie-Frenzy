...
const UserOrdersPage = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await axios.get('https://foodiefrenzy-backend-aeqo.onrender.com/api/orders', {
                      ...
                      <td className="p-4">
                        <div className="space-y-2">
                          {order.items.map((item, index) => (
                            ...
                            >
                              <img
                                src={`https://foodiefrenzy-backend-aeqo.onrender.com/${item.item.imageUrl}`}
                                alt={item.item.name}
